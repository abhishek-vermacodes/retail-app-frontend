      ...
      <View style={styles.drawer}>
        ...
        <View style={styles.switchRow}>
          <View style={styles.switchTextWrapper}>
            ...
            <Text style={styles.switchDesc}>Receive real-time order alerts and stock status updates.</Text>
          </View>
          <Switch
            value={pushEnabled}
        ...
        <View style={styles.switchRow}>
          <View style={styles.switchTextWrapper}>
            ...
            <Text style={styles.switchDesc}>Receive settlement reports and platform alerts.</Text>
          </View>
          <Switch
            value={emailEnabled}
        ...
        <View style={styles.switchRow}>
          <View style={styles.switchTextWrapper}>
            ...
            <Text style={styles.switchDesc}>Receive transactional security codes.</Text>
          </View>
          <Switch
            value={smsEnabled}
